...
public interface VisitorSurveyAnswerRepository extends JpaRepository<VisitorSurveyAnswer, Long> {
    ...
    @Query("select vsa.option.mbtiType from VisitorSurveyAnswer vsa where vsa.visitorSurveyResult.visitor = :visitor")
    public List<EnumMbtiType> findScoreByVisitorId(@Param("visitor") Visitor visitor);
