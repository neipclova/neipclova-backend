...
VALUES
    ...
    (null, '{"student":"수업 끝나기 한시간 전 선배가 고기 사준다고 한다 속마음은?", "worker": "퇴근 한시간 전 상사가 회식하자고 한다 속마음은?"}', 20, 'CLUB'),
    (null, '{"student":"하교길.. 덜 친한 친구가 자기 부모님이 태워주시니 같이 가자고 한다", "worker": "퇴근길.. 집 방향이 같은 사수가 태워주겠다고 한다"}', 21, 'CLUB');